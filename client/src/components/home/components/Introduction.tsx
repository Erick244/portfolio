    ...
    return (
        ...
        >
            ...
            <P className="text-center">
                ...
                old and I&apos;ve been studying programming for two and a half
                years. During this period I focused on specializing in Fullstack
                development for the Web. My goal today is to gain more and more
