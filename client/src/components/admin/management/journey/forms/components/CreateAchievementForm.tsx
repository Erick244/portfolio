...
export function CreateAchievementForm() {
    ...
    async function onSubmit(
        createAchievementFormData: CreateAchievementFormData
    ) {
        const dateFormatted = format(createAchievementFormData.date, "PPP");

        try {
            const data = await postData("/journey", {
                dateFormatted,
            ...
            toast({
                title: "Success",
                description: `Technology "${createAchievementFormData.title}" created!`,
            });
