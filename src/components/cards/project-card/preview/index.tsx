...
export const ProjectCardPreview = {
    Root: ProjectCardPreviewRoot,
    Desktop: ProjectCardDesktopPreview,
    Mobile: ProjectCardMobilePreview,
    Technologies: ProjectCardTechnologiesPreview,
    Technology: ProjectCardTechnologyPreview,
};
